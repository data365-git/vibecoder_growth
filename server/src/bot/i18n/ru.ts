...
export const ru: T = {
  ...
  settingsTitle: '⚙️ Настройки — выбери язык:',
  ...
  briefSavedHint: (id) => `Brief id: #${id}\nКогда задача будет готова, отправь: /delivery ${id}`,

  // ---------- Delivery ----------
  deliveryStart: (id) => `📦 Final delivery для brief #${id}.\n\n1/7 — Что было сделано?`,
  ...
  deliveryUsage: 'Использование: /delivery <briefId>',
  ...
  // ---------- Helper prompts ----------
  helperPleaseSendText: 'Пришли текст, пожалуйста.',
  helperHttpLinkNeeded: 'Нужна ссылка с http(s)://. Попробуй снова.',
  helperNeedMore: (have, need) => `${have}/${need}. Попробуй ещё раз.`,

  // ---------- Inline wizard fragments ----------
  briefNeedAtLeastOneStep: 'Нужен хотя бы 1 шаг.',
  deliveryOnTime: '✅ В срок.',
  deliveryLate: '⚠️ После дедлайна.',

  // ---------- Scheduler DMs ----------
  nudgeReportSoft: '💡 Напоминание: до 18:00 нужно отправить /report.',
  nudgeReportFinal: '⏰ Осталось 30 минут до закрытия окна. /report сейчас.',
};
